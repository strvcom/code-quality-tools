...
| ESLint     | [@strv/eslint-config-functional](packages/eslint-config-functional)                     | [![@strv/eslint-config-functional][ec-functional-badge]][ec-functional-npm]       | ESlint ruleset for functional programming|
...
[ec-functional-npm]: https://npmjs.org/package/@strv/eslint-config-functional
[ec-functional-badge]: https://img.shields.io/npm/v/@strv/eslint-config-functional.svg?style=flat-square
